...
### 🛡️ Input Validation Rules & Exact Error Messages
...
### 🗄️ Database Information (PostgreSQL)
...
### [SUCCESS] Acceptance Criteria (AC)
1. **AC1 - Successful Checkout (Happy Path)**:
